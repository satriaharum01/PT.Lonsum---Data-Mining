...
const History = ({ subTitle, title }) => {
    ...
    const deletePost = async (id) => {
        //delete with api
        await Api.delete(`/data/history/delete/${id}`).then(() => {
            setDataList([]);
            fetchDataList();
        });
    };
    ...
    useEffect(() => {
        $("body").on("click", ".btn-pdf", function () {
            ...
            window.open(`history/cetak`, "_blank");
        });
                            ...
                            <div className="card">
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div className="card-options align-items-center">
                                        <button className="btn btn-danger btn-pdf">
                                            <i className="fa fa-file-pdf"></i>{" "}
                                            Cetak
                                        </button>
                                        <button
                                            className="btn btn-success btn-filter mx-2"
